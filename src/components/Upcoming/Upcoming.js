    ...
    state = {
      ...
      loadMoreItems = () => {
        ...
        if (this.state.searchTerm === '') {
          endpoint = `${API_URL}movie/upcoming?api_key=${API_KEY}&language=en-US&page=${this.state.currnetPage + 1}`;
        } else {
        ...
        fetch(endpoint).then(result => result.json())
          .then(result => {
            ...
            this.setState({
              ...
              if (this.state.searchTerm === '') {
                localStorage.setItem('UpcomingState', JSON.stringify(this.state));
              }
            })
          })
      };
        ...
        return (
          <div className="rmdb-home">
            ...
            <div className="rmdb-home-grid">
              <FourColGrid
                header={searchTerm ? 'Search Result' : 'Upcoming Movies'}
                loader={loader}
              >
                {
